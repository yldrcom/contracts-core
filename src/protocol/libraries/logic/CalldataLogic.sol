...
library CalldataLogic {
     ...
     * @return True if receiving yTokens, false otherwise
     */
        ...
        returns (address, address, address, uint256, bool)
    {
        ...
        assembly {
            ...
            receiveYToken := and(shr(128, args2), 0x1)
        }
        ...
        return (reservesList[collateralAssetId], reservesList[debtAssetId], user, debtToCover, receiveYToken);
    }
}
