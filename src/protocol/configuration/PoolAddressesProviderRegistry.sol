 ...
 *
 * @notice Main registry of PoolAddressesProvider of YLDR markets.
 * @dev Used for indexing purposes of YLDR protocol's markets. The id assigned to a PoolAddressesProvider refers to the
 * market it is connected with, for example with `1` for the YLDR main market and `2` for the next created.
 */
