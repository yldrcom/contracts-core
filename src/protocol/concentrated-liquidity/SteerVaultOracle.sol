...
contract SteerVaultOracle is BaseALMOracle {
    ...
    function latestAnswer() external view returns (int256) {
        ...
        uint256 total0 = token0.balanceOf(address(vault)) - vault.accruedSteerFees0() - vault.accruedStrategistFees0();
        uint256 total1 = token1.balanceOf(address(vault)) - vault.accruedSteerFees1() - vault.accruedStrategistFees1();
        uint256 totalFees0;
        uint256 totalFees1;
